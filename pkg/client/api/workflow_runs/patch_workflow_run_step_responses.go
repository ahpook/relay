...
func (o *PatchWorkflowRunStepOKBody) UnmarshalJSON(raw []byte) error {
	...
	var patchWorkflowRunStepOKBodyAO0 models.WorkflowRunStep
	if err := swag.ReadJSON(raw, &patchWorkflowRunStepOKBodyAO0); err != nil {
		return err
	}
	o.WorkflowRunStep = patchWorkflowRunStepOKBodyAO0
...
func (o PatchWorkflowRunStepOKBody) MarshalJSON() ([]byte, error) {
	...
	patchWorkflowRunStepOKBodyAO0, err := swag.WriteJSON(o.WorkflowRunStep)
	if err != nil {
		return nil, err
	}
